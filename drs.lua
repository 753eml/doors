...
-- Sound ID maps for different places
local soundIdMaps = {
    [6839171747] = {
...
if placeIds[game.PlaceId] then
    ...
    -- Use the correct soundIdMap based on the place
    ...
    sendNotification("Error while loading sound modifications", "You are not in Doors!", 10, thumbsDownImage)
end
